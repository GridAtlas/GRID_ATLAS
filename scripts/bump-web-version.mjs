...
const increments = { patch: 0.001, feature: 0.01, milestone: 0.1 };
...
const versionMatch = main.match(/const WEB_VERSION = "(\d+\.\d{3})";/);
const readmeMatch = readme.match(/現在のWeb版は `(\d+\.\d{3})` です。/);
...
const nextVersion = (Number(versionMatch[1]) + increments[kind]).toFixed(3);
